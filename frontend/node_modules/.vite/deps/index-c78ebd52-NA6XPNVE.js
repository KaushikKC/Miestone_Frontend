...
// node_modules/starknetkit/dist/index-c78ebd52.js
var Tu = Object.defineProperty;
var $u = (i, e, t) => e in i ? Tu(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var be = (i, e, t) => ($u(i, typeof e != "symbol" ? e + "" : e, t), t);
var sn = { exports: {} };
var $i = typeof Reflect == "object" ? Reflect : null;
var kn = $i && typeof $i.apply == "function" ? $i.apply : function(e, t, s) {
...
Oe.prototype.listeners = function(e) {
  return ec(this, e, true);
};
Oe.prototype.rawListeners = function(e) {
  return ec(this, e, false);
};
...
function zu(i, e) {
  return new Promise(function(t, s) {
    ...
    sc(i, e, n, { once: true }), e !== "error" && Ku(i, r, { once: true });
  });
}
function Ku(i, e, t) {
...
(function(i) {
  ...
  (function(l) {
    var L = typeof T == "object" ? T : typeof self == "object" ? self : typeof this == "object" ? this : {};
    l(v(L, v(i.exports)));
    function v(R, $) {
      return R !== L && (typeof Object.create == "function" ? Object.defineProperty(R, "__esModule", { value: true }) : R.__esModule = true), function(q, m) {
        return R[q] = $ ? $(q, m) : m;
      };
    }
  })(function(l) {
    ...
    e = function(v, R) {
      ...
      return new ($ || ($ = Promise))(function(_, B) {
        ...
        function U(M) {
          M.done ? _(M.value) : m(M.value).then(z, j2);
        }
      ...
      function q(_) {
        $[_] = v[_] && function(B) {
          return new Promise(function(z, j2) {
            B = v[_](B), m(z, j2, B.done, B.value);
          });
        };
      }
      function m(_, B, z, j2) {
        Promise.resolve(j2).then(function(U) {
          _({ value: U, done: z });
        }, B);
      }
    }, I = function(v, R) {
...
function ku() {
  return Gn || (Gn = 1, function() {
    ...
    }), typeof T < "u" && T.localStorage ? ki.exports = T.localStorage : typeof window < "u" && window.localStorage ? ki.exports = window.localStorage : ki.exports = new e();
  }()), ki.exports;
}
var gr = {};
var Hi = {};
...
function Hu() {
  if (Wn)
    return Hi;
  Wn = 1, Object.defineProperty(Hi, "__esModule", { value: true }), Hi.IKeyValueStorage = void 0;
  class i {
  }
...
function Gu() {
  if (Yn)
    return Gi;
  Yn = 1, Object.defineProperty(Gi, "__esModule", { value: true }), Gi.parseEntry = void 0;
  const i = fs;
  function e(t) {
    var s;
...
function Qu() {
  if (Xn)
    return Yi;
  Xn = 1, Object.defineProperty(Yi, "__esModule", { value: true }), Yi.delay = void 0;
  function i(e) {
...
var Zn;
function Xu() {
  return Zn || (Zn = 1, Object.defineProperty(wi, "__esModule", { value: true }), wi.ONE_THOUSAND = wi.ONE_HUNDRED = void 0, wi.ONE_HUNDRED = 100, wi.ONE_THOUSAND = 1e3), wi;
}
var wr = {};
var eo;
function Zu() {
...
function el() {
  if (io)
    return mi;
  io = 1, Object.defineProperty(mi, "__esModule", { value: true }), mi.fromMiliseconds = mi.toMiliseconds = void 0;
  const i = ac();
  function e(s) {
...
function il() {
  if (ro)
    return Ri;
  ro = 1, Object.defineProperty(Ri, "__esModule", { value: true }), Ri.Watch = void 0;
  class i {
    constructor() {
...
function sl() {
  if (no)
    return Ji;
  no = 1, Object.defineProperty(Ji, "__esModule", { value: true }), Ji.IWatch = void 0;
  class i {
  }
...
function al() {
  if (ao)
    return Qi;
  ao = 1, Object.defineProperty(Qi, "__esModule", { value: true }), Qi.IHeartBeat = void 0;
  const i = ol;
...
function cl() {
  if (ho)
    return bi;
  ho = 1, Object.defineProperty(bi, "__esModule", { value: true }), bi.HEARTBEAT_EVENTS = bi.HEARTBEAT_INTERVAL = void 0;
  const i = V;
...
function hl() {
  if (lo)
    return Wi;
  lo = 1, Object.defineProperty(Wi, "__esModule", { value: true }), Wi.HeartBeat = void 0;
...
function ll() {
  ...
  function r(f) {
    ...
    Array.isArray(f.browser.serialize) && f.browser.serialize.indexOf("!stdSerializers.err") > -1 && (R = false);
    ...
    function U(M, H) {
      ...
      if (v && te) {
        var G = Object.assign({}, L, te), ie = f.browser.serialize === true ? Object.keys(G) : v;
  ...
  function o(f, a, l) {
    !f.transmit && a[l] === F || (a[l] = /* @__PURE__ */ function(L) {
      return function() {
...
var go;
function uc() {
  return go || (go = 1, Object.defineProperty(vi, "__esModule", { value: true }), vi.PINO_CUSTOM_CONTEXT_KEY = vi.PINO_LOGGER_DEFAULTS = void 0, vi.PINO_LOGGER_DEFAULTS = {
    level: "info"
...
function dl() {
  if (yo)
    return yt;
  yo = 1, Object.defineProperty(yt, "__esModule", { value: true }), yt.generateChildLogger = yt.formatChildLoggerContext = yt.getLoggerContext = yt.setBrowserLoggerContext = yt.getBrowserLoggerContext = yt.getDefaultLoggerOptions = void 0;
  const i = uc();
  function e(c) {
...
(function(i) {
      ...
      return c.prototype._initState = function() {
        ...
        if (!this._finished) {
          ...
          for (var E = p + 1; E < x - 8; E++)
            this._buffer[E] = 0;
          e.writeUint32BE(w, this._buffer, x - 8), e.writeUint32BE(D, this._buffer, x - 4), n(this._tempHi, this._tempLo, this._stateHi, this._stateLo, this._buffer, 0, x), this._finished = true;
        }
  ...
  function n(c, u, d, p, w, D, x) {
    for (var E = d[0], C = d[1], F = d[2], K = d[3], I = d[4], O = d[5], y = d[6], b = d[7], f = p[0], a = p[1], l = p[2], L = p[3], v = p[4], R = p[5], $ = p[6], q = p[7], m, _, B, z, j2, U, M, H; x >= 128; ) {
      for (var te = 0; te < 16; te++) {
        var G = 8 * te + D;
        c[te] = e.readUint32BE(w, G), u[te] = e.readUint32BE(w, G + 4);
      }
      for (var te = 0; te < 80; te++) {
        var ie = E, Q = C, se = F, T2 = K, A = I, N = O, h2 = y, S = b, W = f, X = a, fe = l, ve = L, ge = v, Se = R, Me = $, $e = q;
        if (m = b, _ = q, j2 = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = (I >>> 14 | v << 32 - 14) ^ (I >>> 18 | v << 32 - 18) ^ (v >>> 41 - 32 | I << 32 - (41 - 32)), _ = (v >>> 14 | I << 32 - 14) ^ (v >>> 18 | I << 32 - 18) ^ (I >>> 41 - 32 | v << 32 - (41 - 32)), j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, m = I & O ^ ~I & y, _ = v & R ^ ~v & $, j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, m = r[te * 2], _ = r[te * 2 + 1], j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, m = c[te % 16], _ = u[te % 16], j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j2 >>> 16, M += U >>> 16, H += M >>> 16, B = M & 65535 | H << 16, z = j2 & 65535 | U << 16, m = B, _ = z, j2 = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = (E >>> 28 | f << 32 - 28) ^ (f >>> 34 - 32 | E << 32 - (34 - 32)) ^ (f >>> 39 - 32 | E << 32 - (39 - 32)), _ = (f >>> 28 | E << 32 - 28) ^ (E >>> 34 - 32 | f << 32 - (34 - 32)) ^ (E >>> 39 - 32 | f << 32 - (39 - 32)), j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, m = E & C ^ E & F ^ C & F, _ = f & a ^ f & l ^ a & l, j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j2 >>> 16, M += U >>> 16, H += M >>> 16, S = M & 65535 | H << 16, $e = j2 & 65535 | U << 16, m = T2, _ = ve, j2 = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = B, _ = z, j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j2 >>> 16, M += U >>> 16, H += M >>> 16, T2 = M & 65535 | H << 16, ve = j2 & 65535 | U << 16, C = ie, F = Q, K = se, I = T2, O = A, y = N, b = h2, E = S, a = W, l = X, L = fe, v = ve, R = ge, $ = Se, q = Me, f = $e, te % 16 === 15)
          for (var G = 0; G < 16; G++)
            m = c[G], _ = u[G], j2 = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = c[(G + 9) % 16], _ = u[(G + 9) % 16], j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, B = c[(G + 1) % 16], z = u[(G + 1) % 16], m = (B >>> 1 | z << 32 - 1) ^ (B >>> 8 | z << 32 - 8) ^ B >>> 7, _ = (z >>> 1 | B << 32 - 1) ^ (z >>> 8 | B << 32 - 8) ^ (z >>> 7 | B << 32 - 7), j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, B = c[(G + 14) % 16], z = u[(G + 14) % 16], m = (B >>> 19 | z << 32 - 19) ^ (z >>> 61 - 32 | B << 32 - (61 - 32)) ^ B >>> 6, _ = (z >>> 19 | B << 32 - 19) ^ (B >>> 61 - 32 | z << 32 - (61 - 32)) ^ (z >>> 6 | B << 32 - 6), j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j2 >>> 16, M += U >>> 16, H += M >>> 16, c[G] = M & 65535 | H << 16, u[G] = j2 & 65535 | U << 16;
      }
      m = E, _ = f, j2 = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[0], _ = p[0], j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j2 >>> 16, M += U >>> 16, H += M >>> 16, d[0] = E = M & 65535 | H << 16, p[0] = f = j2 & 65535 | U << 16, m = C, _ = a, j2 = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[1], _ = p[1], j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j2 >>> 16, M += U >>> 16, H += M >>> 16, d[1] = C = M & 65535 | H << 16, p[1] = a = j2 & 65535 | U << 16, m = F, _ = l, j2 = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[2], _ = p[2], j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j2 >>> 16, M += U >>> 16, H += M >>> 16, d[2] = F = M & 65535 | H << 16, p[2] = l = j2 & 65535 | U << 16, m = K, _ = L, j2 = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[3], _ = p[3], j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j2 >>> 16, M += U >>> 16, H += M >>> 16, d[3] = K = M & 65535 | H << 16, p[3] = L = j2 & 65535 | U << 16, m = I, _ = v, j2 = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[4], _ = p[4], j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j2 >>> 16, M += U >>> 16, H += M >>> 16, d[4] = I = M & 65535 | H << 16, p[4] = v = j2 & 65535 | U << 16, m = O, _ = R, j2 = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[5], _ = p[5], j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j2 >>> 16, M += U >>> 16, H += M >>> 16, d[5] = O = M & 65535 | H << 16, p[5] = R = j2 & 65535 | U << 16, m = y, _ = $, j2 = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[6], _ = p[6], j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j2 >>> 16, M += U >>> 16, H += M >>> 16, d[6] = y = M & 65535 | H << 16, p[6] = $ = j2 & 65535 | U << 16, m = b, _ = q, j2 = _ & 65535, U = _ >>> 16, M = m & 65535, H = m >>> 16, m = d[7], _ = p[7], j2 += _ & 65535, U += _ >>> 16, M += m & 65535, H += m >>> 16, U += j2 >>> 16, M += U >>> 16, H += M >>> 16, d[7] = b = M & 65535 | H << 16, p[7] = q = j2 & 65535 | U << 16, D += 128, x -= 128;
    }
    return D;
  }
  function o(c) {
...
(function(i) {
  ...
  function E(T2) {
    ...
    for (let N = 0; N < 16; N++) {
      let h2 = T2[N] + A + 65535;
      A = Math.floor(h2 / 65536), T2[N] = h2 - A * 65536;
    }
    T2[0] += A - 1 + 37 * (A - 1);
  }
  function C(T2, A, N) {
  ...
  function F(T2, A) {
    ...
    for (let S = 0; S < 2; S++) {
      N[0] = h2[0] - 65517;
      for (let X = 1; X < 15; X++)
        N[X] = h2[X] - 65535 - (N[X - 1] >> 16 & 1), N[X - 1] &= 65535;
      N[15] = h2[15] - 32767 - (N[14] >> 16 & 1);
      const W = N[15] >> 16 & 1;
      N[14] &= 65535, C(h2, N, 1 - W);
    }
    for (let S = 0; S < 16; S++)
      T2[2 * S] = h2[S] & 255, T2[2 * S + 1] = h2[S] >> 8;
  }
  function K(T2, A) {
    let N = 0;
  ...
  function I(T2, A) {
    const N = new Uint8Array(32), h2 = new Uint8Array(32);
    return F(N, T2), F(h2, A), K(N, h2);
  }
  function O(T2) {
  ...
  function a(T2, A, N) {
    let h2, S, W = 0, X = 0, fe = 0, ve = 0, ge = 0, Se = 0, Me = 0, $e = 0, we = 0, ye = 0, pe = 0, le = 0, ue = 0, he = 0, ce = 0, re = 0, de = 0, me = 0, ne = 0, _e = 0, Ee = 0, De = 0, xe = 0, Ie = 0, Ut = 0, qt = 0, si = 0, Dt = 0, fi = 0, Ki = 0, Os = 0, qe = N[0], Fe = N[1], je = N[2], ze = N[3], Ke = N[4], Ue = N[5], Qe = N[6], Xe = N[7], Ze = N[8], et = N[9], tt = N[10], Ye = N[11], Ve = N[12], Ae = N[13], it = N[14], st = N[15];
    h2 = A[0], W += h2 * qe, X += h2 * Fe, fe += h2 * je, ve += h2 * ze, ge += h2 * Ke, Se += h2 * Ue, Me += h2 * Qe, $e += h2 * Xe, we += h2 * Ze, ye += h2 * et, pe += h2 * tt, le += h2 * Ye, ue += h2 * Ve, he += h2 * Ae, ce += h2 * it, re += h2 * st, h2 = A[1], X += h2 * qe, fe += h2 * Fe, ve += h2 * je, ge += h2 * ze, Se += h2 * Ke, Me += h2 * Ue, $e += h2 * Qe, we += h2 * Xe, ye += h2 * Ze, pe += h2 * et, le += h2 * tt, ue += h2 * Ye, he += h2 * Ve, ce += h2 * Ae, re += h2 * it, de += h2 * st, h2 = A[2], fe += h2 * qe, ve += h2 * Fe, ge += h2 * je, Se += h2 * ze, Me += h2 * Ke, $e += h2 * Ue, we += h2 * Qe, ye += h2 * Xe, pe += h2 * Ze, le += h2 * et, ue += h2 * tt, he += h2 * Ye, ce += h2 * Ve, re += h2 * Ae, de += h2 * it, me += h2 * st, h2 = A[3], ve += h2 * qe, ge += h2 * Fe, Se += h2 * je, Me += h2 * ze, $e += h2 * Ke, we += h2 * Ue, ye += h2 * Qe, pe += h2 * Xe, le += h2 * Ze, ue += h2 * et, he += h2 * tt, ce += h2 * Ye, re += h2 * Ve, de += h2 * Ae, me += h2 * it, ne += h2 * st, h2 = A[4], ge += h2 * qe, Se += h2 * Fe, Me += h2 * je, $e += h2 * ze, we += h2 * Ke, ye += h2 * Ue, pe += h2 * Qe, le += h2 * Xe, ue += h2 * Ze, he += h2 * et, ce += h2 * tt, re += h2 * Ye, de += h2 * Ve, me += h2 * Ae, ne += h2 * it, _e += h2 * st, h2 = A[5], Se += h2 * qe, Me += h2 * Fe, $e += h2 * je, we += h2 * ze, ye += h2 * Ke, pe += h2 * Ue, le += h2 * Qe, ue += h2 * Xe, he += h2 * Ze, ce += h2 * et, re += h2 * tt, de += h2 * Ye, me += h2 * Ve, ne += h2 * Ae, _e += h2 * it, Ee += h2 * st, h2 = A[6], Me += h2 * qe, $e += h2 * Fe, we += h2 * je, ye += h2 * ze, pe += h2 * Ke, le += h2 * Ue, ue += h2 * Qe, he += h2 * Xe, ce += h2 * Ze, re += h2 * et, de += h2 * tt, me += h2 * Ye, ne += h2 * Ve, _e += h2 * Ae, Ee += h2 * it, De += h2 * st, h2 = A[7], $e += h2 * qe, we += h2 * Fe, ye += h2 * je, pe += h2 * ze, le += h2 * Ke, ue += h2 * Ue, he += h2 * Qe, ce += h2 * Xe, re += h2 * Ze, de += h2 * et, me += h2 * tt, ne += h2 * Ye, _e += h2 * Ve, Ee += h2 * Ae, De += h2 * it, xe += h2 * st, h2 = A[8], we += h2 * qe, ye += h2 * Fe, pe += h2 * je, le += h2 * ze, ue += h2 * Ke, he += h2 * Ue, ce += h2 * Qe, re += h2 * Xe, de += h2 * Ze, me += h2 * et, ne += h2 * tt, _e += h2 * Ye, Ee += h2 * Ve, De += h2 * Ae, xe += h2 * it, Ie += h2 * st, h2 = A[9], ye += h2 * qe, pe += h2 * Fe, le += h2 * je, ue += h2 * ze, he += h2 * Ke, ce += h2 * Ue, re += h2 * Qe, de += h2 * Xe, me += h2 * Ze, ne += h2 * et, _e += h2 * tt, Ee += h2 * Ye, De += h2 * Ve, xe += h2 * Ae, Ie += h2 * it, Ut += h2 * st, h2 = A[10], pe += h2 * qe, le += h2 * Fe, ue += h2 * je, he += h2 * ze, ce += h2 * Ke, re += h2 * Ue, de += h2 * Qe, me += h2 * Xe, ne += h2 * Ze, _e += h2 * et, Ee += h2 * tt, De += h2 * Ye, xe += h2 * Ve, Ie += h2 * Ae, Ut += h2 * it, qt += h2 * st, h2 = A[11], le += h2 * qe, ue += h2 * Fe, he += h2 * je, ce += h2 * ze, re += h2 * Ke, de += h2 * Ue, me += h2 * Qe, ne += h2 * Xe, _e += h2 * Ze, Ee += h2 * et, De += h2 * tt, xe += h2 * Ye, Ie += h2 * Ve, Ut += h2 * Ae, qt += h2 * it, si += h2 * st, h2 = A[12], ue += h2 * qe, he += h2 * Fe, ce += h2 * je, re += h2 * ze, de += h2 * Ke, me += h2 * Ue, ne += h2 * Qe, _e += h2 * Xe, Ee += h2 * Ze, De += h2 * et, xe += h2 * tt, Ie += h2 * Ye, Ut += h2 * Ve, qt += h2 * Ae, si += h2 * it, Dt += h2 * st, h2 = A[13], he += h2 * qe, ce += h2 * Fe, re += h2 * je, de += h2 * ze, me += h2 * Ke, ne += h2 * Ue, _e += h2 * Qe, Ee += h2 * Xe, De += h2 * Ze, xe += h2 * et, Ie += h2 * tt, Ut += h2 * Ye, qt += h2 * Ve, si += h2 * Ae, Dt += h2 * it, fi += h2 * st, h2 = A[14], ce += h2 * qe, re += h2 * Fe, de += h2 * je, me += h2 * ze, ne += h2 * Ke, _e += h2 * Ue, Ee += h2 * Qe, De += h2 * Xe, xe += h2 * Ze, Ie += h2 * et, Ut += h2 * tt, qt += h2 * Ye, si += h2 * Ve, Dt += h2 * Ae, fi += h2 * it, Ki += h2 * st, h2 = A[15], re += h2 * qe, de += h2 * Fe, me += h2 * je, ne += h2 * ze, _e += h2 * Ke, Ee += h2 * Ue, De += h2 * Qe, xe += h2 * Xe, Ie += h2 * Ze, Ut += h2 * et, qt += h2 * tt, si += h2 * Ye, Dt += h2 * Ve, fi += h2 * Ae, Ki += h2 * it, Os += h2 * st, W += 38 * de, X += 38 * me, fe += 38 * ne, ve += 38 * _e, ge += 38 * Ee, Se += 38 * De, Me += 38 * xe, $e += 38 * Ie, we += 38 * Ut, ye += 38 * qt, pe += 38 * si, le += 38 * Dt, ue += 38 * fi, he += 38 * Ki, ce += 38 * Os, S = 1, h2 = W + S + 65535, S = Math.floor(h2 / 65536), W = h2 - S * 65536, h2 = X + S + 65535, S = Math.floor(h2 / 65536), X = h2 - S * 65536, h2 = fe + S + 65535, S = Math.floor(h2 / 65536), fe = h2 - S * 65536, h2 = ve + S + 65535, S = Math.floor(h2 / 65536), ve = h2 - S * 65536, h2 = ge + S + 65535, S = Math.floor(h2 / 65536), ge = h2 - S * 65536, h2 = Se + S + 65535, S = Math.floor(h2 / 65536), Se = h2 - S * 65536, h2 = Me + S + 65535, S = Math.floor(h2 / 65536), Me = h2 - S * 65536, h2 = $e + S + 65535, S = Math.floor(h2 / 65536), $e = h2 - S * 65536, h2 = we + S + 65535, S = Math.floor(h2 / 65536), we = h2 - S * 65536, h2 = ye + S + 65535, S = Math.floor(h2 / 65536), ye = h2 - S * 65536, h2 = pe + S + 65535, S = Math.floor(h2 / 65536), pe = h2 - S * 65536, h2 = le + S + 65535, S = Math.floor(h2 / 65536), le = h2 - S * 65536, h2 = ue + S + 65535, S = Math.floor(h2 / 65536), ue = h2 - S * 65536, h2 = he + S + 65535, S = Math.floor(h2 / 65536), he = h2 - S * 65536, h2 = ce + S + 65535, S = Math.floor(h2 / 65536), ce = h2 - S * 65536, h2 = re + S + 65535, S = Math.floor(h2 / 65536), re = h2 - S * 65536, W += S - 1 + 37 * (S - 1), S = 1, h2 = W + S + 65535, S = Math.floor(h2 / 65536), W = h2 - S * 65536, h2 = X + S + 65535, S = Math.floor(h2 / 65536), X = h2 - S * 65536, h2 = fe + S + 65535, S = Math.floor(h2 / 65536), fe = h2 - S * 65536, h2 = ve + S + 65535, S = Math.floor(h2 / 65536), ve = h2 - S * 65536, h2 = ge + S + 65535, S = Math.floor(h2 / 65536), ge = h2 - S * 65536, h2 = Se + S + 65535, S = Math.floor(h2 / 65536), Se = h2 - S * 65536, h2 = Me + S + 65535, S = Math.floor(h2 / 65536), Me = h2 - S * 65536, h2 = $e + S + 65535, S = Math.floor(h2 / 65536), $e = h2 - S * 65536, h2 = we + S + 65535, S = Math.floor(h2 / 65536), we = h2 - S * 65536, h2 = ye + S + 65535, S = Math.floor(h2 / 65536), ye = h2 - S * 65536, h2 = pe + S + 65535, S = Math.floor(h2 / 65536), pe = h2 - S * 65536, h2 = le + S + 65535, S = Math.floor(h2 / 65536), le = h2 - S * 65536, h2 = ue + S + 65535, S = Math.floor(h2 / 65536), ue = h2 - S * 65536, h2 = he + S + 65535, S = Math.floor(h2 / 65536), he = h2 - S * 65536, h2 = ce + S + 65535, S = Math.floor(h2 / 65536), ce = h2 - S * 65536, h2 = re + S + 65535, S = Math.floor(h2 / 65536), re = h2 - S * 65536, W += S - 1 + 37 * (S - 1), T2[0] = W, T2[1] = X, T2[2] = fe, T2[3] = ve, T2[4] = ge, T2[5] = Se, T2[6] = Me, T2[7] = $e, T2[8] = we, T2[9] = ye, T2[10] = pe, T2[11] = le, T2[12] = ue, T2[13] = he, T2[14] = ce, T2[15] = re;
  }
  function l(T2, A) {
    a(T2, A, A);
  }
  ...
  function R(T2, A) {
    const N = r(), h2 = r(), S = r(), W = r(), X = r(), fe = r(), ve = r(), ge = r(), Se = r();
    f(N, T2[1], T2[0]), f(Se, A[1], A[0]), a(N, N, Se), b(h2, T2[0], T2[1]), b(Se, A[0], A[1]), a(h2, h2, Se), a(S, T2[3], A[3]), a(S, S, d), a(W, T2[2], A[2]), b(W, W, W), f(X, h2, N), f(fe, W, S), b(ve, W, S), b(ge, h2, N), a(T2[0], X, fe), a(T2[1], ge, ve), a(T2[2], ve, fe), a(T2[3], X, ge);
  }
  function $(T2, A, N) {
  ...
  function q(T2, A) {
    const N = r(), h2 = r(), S = r();
    L(S, A[2]), a(N, A[0], S), a(h2, A[1], S), F(T2, h2), T2[31] ^= O(N) << 7;
  }
  function m(T2, A, N) {
    x(T2[0], o), x(T2[1], c), x(T2[2], c), x(T2[3], o);
    for (let h2 = 255; h2 >= 0; --h2) {
      const S = N[h2 / 8 | 0] >> (h2 & 7) & 1;
      $(T2, A, S), R(A, T2), R(T2, T2), $(T2, A, S);
    }
  }
  function _(T2, A) {
    const N = [r(), r(), r(), r()];
    x(N[0], p), x(N[1], w), x(N[2], c), a(N[3], p, w), m(T2, N, A);
  }
  function B(T2) {
    if (T2.length !== i.SEED_LENGTH)
      throw new Error(`ed25519: seed must be ${i.SEED_LENGTH} bytes`);
    const A = (0, t.hash)(T2);
    A[0] &= 248, A[31] &= 127, A[31] |= 64;
    const N = new Uint8Array(32), h2 = [r(), r(), r(), r()];
    _(h2, A), q(N, h2);
    const S = new Uint8Array(64);
    return S.set(T2), S.set(N, 32), {
      publicKey: N,
      secretKey: S
    };
  }
  ...
  function z(T2) {
    const A = (0, e.randomBytes)(32, T2), N = B(A);
    return (0, s.wipe)(A), N;
  }
  i.generateKeyPair = z;
  function j2(T2) {
    if (T2.length !== i.SECRET_KEY_LENGTH)
      throw new Error(`ed25519: secret key must be ${i.SECRET_KEY_LENGTH} bytes`);
    return new Uint8Array(T2.subarray(32));
  }
  i.extractPublicKeyFromSecretKey = j2;
  ...
  function M(T2, A) {
    let N, h2, S, W;
    for (h2 = 63; h2 >= 32; --h2) {
      for (N = 0, S = h2 - 32, W = h2 - 12; S < W; ++S)
        A[S] += N - 16 * A[h2] * U[S - (h2 - 32)], N = Math.floor((A[S] + 128) / 256), A[S] -= N * 256;
      A[S] += N, A[h2] = 0;
    }
    for (N = 0, S = 0; S < 32; S++)
  ...
  function te(T2, A) {
    const N = new Float64Array(64), h2 = [r(), r(), r(), r()], S = (0, t.hash)(T2.subarray(0, 32));
    ...
    const fe = X.digest();
    X.clean(), H(fe), _(h2, fe), q(W, h2), X.reset(), X.update(W.subarray(0, 32)), X.update(T2.subarray(32)), X.update(A);
    const ve = X.digest();
    H(ve);
  ...
  i.sign = te;
  function G(T2, A) {
    const N = r(), h2 = r(), S = r(), W = r(), X = r(), fe = r(), ve = r();
    return x(T2[2], c), y(T2[1], A), l(S, T2[1]), a(W, S, u), f(S, S, T2[2]), b(W, T2[2], W), l(X, W), l(fe, X), a(ve, fe, X), a(N, ve, S), a(N, N, W), v(N, N), a(N, N, S), a(N, N, W), a(N, N, W), a(T2[0], N, W), l(h2, T2[0]), a(h2, h2, W), I(h2, S) && a(T2[0], T2[0], D), l(h2, T2[0]), a(h2, h2, W), I(h2, S) ? -1 : (O(T2[0]) === A[31] >> 7 && f(T2[0], o, T2[0]), a(T2[3], T2[0], T2[1]), 0);
  }
  function ie(T2, A, N) {
    const h2 = new Uint8Array(32), S = [r(), r(), r(), r()], W = [r(), r(), r(), r()];
    if (N.length !== i.SIGNATURE_LENGTH)
      throw new Error(`ed25519: signature must be ${i.SIGNATURE_LENGTH} bytes`);
    if (G(W, T2))
      return false;
    const X = new t.SHA512();
    X.update(N.subarray(0, 32)), X.update(T2), X.update(A);
    const fe = X.digest();
    return H(fe), m(S, W, fe), _(W, N.subarray(32)), R(S, W), q(h2, S), !K(N, h2);
  }
  i.verify = ie;
  function Q(T2) {
    let A = [r(), r(), r(), r()];
    ...
    let N = r(), h2 = r(), S = A[1];
    b(N, c, S), f(h2, c, S), L(h2, h2), a(N, N, h2);
    let W = new Uint8Array(32);
    return F(W, N), W;
  }
  i.convertPublicKeyToX25519 = Q;
  function se(T2) {
    const A = (0, t.hash)(T2.subarray(0, 32));
    A[0] &= 248, A[31] &= 127, A[31] |= 64;
...
var wd = (i) => new TextDecoder().decode(i);
var bd = class {
  constructor(e, t, s) {
...
var ar = ({ name: i, prefix: e, encode: t, decode: s }) => new Ed(i, e, t, s);
...
var ut = ({ name: i, prefix: e, bitsPerChar: t, alphabet: s }) => ar({
  prefix: e,
  name: i,
  encode(r) {
    return Id(r, s, t);
...
var Ec = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂");
var rf = Ec.reduce((i, e, t) => (i[t] = e, i), []);
var nf = Ec.reduce((i, e, t) => (i[e.codePointAt(0)] = t, i), []);
function of(i) {
...
var vo = Sc("utf8", "u", (i) => "u" + new TextDecoder("utf8").decode(i), (i) => new TextEncoder().encode(i.substring(1)));
var Ir = Sc("ascii", "a", (i) => {
  let e = "a";
...
var ff = 20;
function pf(i, e, t) {
  for (var s = 1634760805, r = 857760878, n = 2036477234, o = 1797285236, c = t[3] << 24 | t[2] << 16 | t[1] << 8 | t[0], u = t[7] << 24 | t[6] << 16 | t[5] << 8 | t[4], d = t[11] << 24 | t[10] << 16 | t[9] << 8 | t[8], p = t[15] << 24 | t[14] << 16 | t[13] << 8 | t[12], w = t[19] << 24 | t[18] << 16 | t[17] << 8 | t[16], D = t[23] << 24 | t[22] << 16 | t[21] << 8 | t[20], x = t[27] << 24 | t[26] << 16 | t[25] << 8 | t[24], E = t[31] << 24 | t[30] << 16 | t[29] << 8 | t[28], C = e[3] << 24 | e[2] << 16 | e[1] << 8 | e[0], F = e[7] << 24 | e[6] << 16 | e[5] << 8 | e[4], K = e[11] << 24 | e[10] << 16 | e[9] << 8 | e[8], I = e[15] << 24 | e[14] << 16 | e[13] << 8 | e[12], O = s, y = r, b = n, f = o, a = c, l = u, L = d, v = p, R = w, $ = D, q = x, m = E, _ = C, B = F, z = K, j2 = I, U = 0; U < ff; U += 2)
    O = O + a | 0, _ ^= O, _ = _ >>> 32 - 16 | _ << 16, R = R + _ | 0, a ^= R, a = a >>> 32 - 12 | a << 12, y = y + l | 0, B ^= y, B = B >>> 32 - 16 | B << 16, $ = $ + B | 0, l ^= $, l = l >>> 32 - 12 | l << 12, b = b + L | 0, z ^= b, z = z >>> 32 - 16 | z << 16, q = q + z | 0, L ^= q, L = L >>> 32 - 12 | L << 12, f = f + v | 0, j2 ^= f, j2 = j2 >>> 32 - 16 | j2 << 16, m = m + j2 | 0, v ^= m, v = v >>> 32 - 12 | v << 12, b = b + L | 0, z ^= b, z = z >>> 32 - 8 | z << 8, q = q + z | 0, L ^= q, L = L >>> 32 - 7 | L << 7, f = f + v | 0, j2 ^= f, j2 = j2 >>> 32 - 8 | j2 << 8, m = m + j2 | 0, v ^= m, v = v >>> 32 - 7 | v << 7, y = y + l | 0, B ^= y, B = B >>> 32 - 8 | B << 8, $ = $ + B | 0, l ^= $, l = l >>> 32 - 7 | l << 7, O = O + a | 0, _ ^= O, _ = _ >>> 32 - 8 | _ << 8, R = R + _ | 0, a ^= R, a = a >>> 32 - 7 | a << 7, O = O + l | 0, j2 ^= O, j2 = j2 >>> 32 - 16 | j2 << 16, q = q + j2 | 0, l ^= q, l = l >>> 32 - 12 | l << 12, y = y + L | 0, _ ^= y, _ = _ >>> 32 - 16 | _ << 16, m = m + _ | 0, L ^= m, L = L >>> 32 - 12 | L << 12, b = b + v | 0, B ^= b, B = B >>> 32 - 16 | B << 16, R = R + B | 0, v ^= R, v = v >>> 32 - 12 | v << 12, f = f + a | 0, z ^= f, z = z >>> 32 - 16 | z << 16, $ = $ + z | 0, a ^= $, a = a >>> 32 - 12 | a << 12, b = b + v | 0, B ^= b, B = B >>> 32 - 8 | B << 8, R = R + B | 0, v ^= R, v = v >>> 32 - 7 | v << 7, f = f + a | 0, z ^= f, z = z >>> 32 - 8 | z << 8, $ = $ + z | 0, a ^= $, a = a >>> 32 - 7 | a << 7, y = y + L | 0, _ ^= y, _ = _ >>> 32 - 8 | _ << 8, m = m + _ | 0, L ^= m, L = L >>> 32 - 7 | L << 7, O = O + l | 0, j2 ^= O, j2 = j2 >>> 32 - 8 | j2 << 8, q = q + j2 | 0, l ^= q, l = l >>> 32 - 7 | l << 7;
  pt.writeUint32LE(O + s | 0, i, 0), pt.writeUint32LE(y + r | 0, i, 4), pt.writeUint32LE(b + n | 0, i, 8), pt.writeUint32LE(f + o | 0, i, 12), pt.writeUint32LE(a + c | 0, i, 16), pt.writeUint32LE(l + u | 0, i, 20), pt.writeUint32LE(L + d | 0, i, 24), pt.writeUint32LE(v + p | 0, i, 28), pt.writeUint32LE(R + w | 0, i, 32), pt.writeUint32LE($ + D | 0, i, 36), pt.writeUint32LE(q + x | 0, i, 40), pt.writeUint32LE(m + E | 0, i, 44), pt.writeUint32LE(_ + C | 0, i, 48), pt.writeUint32LE(B + F | 0, i, 52), pt.writeUint32LE(z + K | 0, i, 56), pt.writeUint32LE(j2 + I | 0, i, 60);
}
...
di.compare = Nc;
function bf(i, e) {
  return i.length === 0 || e.length === 0 ? false : Nc(i, e) !== 0;
}
di.equal = bf;
(function(i) {
  Object.defineProperty(i, "__esModule", { value: true });
    ...
    function() {
      ...
      return o.prototype._blocks = function(c, u, d) {
        for (var p = this._fin ? 0 : 2048, w = this._h[0], D = this._h[1], x = this._h[2], E = this._h[3], C = this._h[4], F = this._h[5], K = this._h[6], I = this._h[7], O = this._h[8], y = this._h[9], b = this._r[0], f = this._r[1], a = this._r[2], l = this._r[3], L = this._r[4], v = this._r[5], R = this._r[6], $ = this._r[7], q = this._r[8], m = this._r[9]; d >= 16; ) {
          ...
          var z = c[u + 4] | c[u + 5] << 8;
          x += (B >>> 10 | z << 6) & 8191;
          var j2 = c[u + 6] | c[u + 7] << 8;
          E += (z >>> 7 | j2 << 9) & 8191;
          var U = c[u + 8] | c[u + 9] << 8;
          C += (j2 >>> 4 | U << 12) & 8191, F += U >>> 1 & 8191;
          ...
          var T2 = G;
          T2 += w * l, T2 += D * a, T2 += x * f, T2 += E * b, T2 += C * (5 * m), G = T2 >>> 13, T2 &= 8191, T2 += F * (5 * q), T2 += K * (5 * $), T2 += I * (5 * R), T2 += O * (5 * v), T2 += y * (5 * L), G += T2 >>> 13, T2 &= 8191;
          var A = G;
          ...
          var h2 = G;
          h2 += w * R, h2 += D * v, h2 += x * L, h2 += E * l, h2 += C * a, G = h2 >>> 13, h2 &= 8191, h2 += F * f, h2 += K * b, h2 += I * (5 * m), h2 += O * (5 * q), h2 += y * (5 * $), G += h2 >>> 13, h2 &= 8191;
          var S = G;
          ...
          var X = G;
          X += w * m, X += D * q, X += x * $, X += E * R, X += C * v, G = X >>> 13, X &= 8191, X += F * L, X += K * l, X += I * a, X += O * f, X += y * b, G += X >>> 13, X &= 8191, G = (G << 2) + G | 0, G = G + ie | 0, ie = G & 8191, G = G >>> 13, Q += G, w = ie, D = Q, x = se, E = T2, C = A, F = N, K = h2, I = S, O = W, y = X, u += 16, d -= 16;
        }
    ...
    function() {
      ...
      return c.prototype._initState = function() {
        ...
        if (!this._finished) {
          ...
          for (var E = p + 1; E < x - 8; E++)
            this._buffer[E] = 0;
          e.writeUint32BE(w, this._buffer, x - 8), e.writeUint32BE(D, this._buffer, x - 4), n(this._temp, this._state, this._buffer, 0, x), this._finished = true;
        }
...
(function(i) {
  ...
  function D(y, b, f) {
    let a, l, L = 0, v = 0, R = 0, $ = 0, q = 0, m = 0, _ = 0, B = 0, z = 0, j2 = 0, U = 0, M = 0, H = 0, te = 0, G = 0, ie = 0, Q = 0, se = 0, T2 = 0, A = 0, N = 0, h2 = 0, S = 0, W = 0, X = 0, fe = 0, ve = 0, ge = 0, Se = 0, Me = 0, $e = 0, we = f[0], ye = f[1], pe = f[2], le = f[3], ue = f[4], he = f[5], ce = f[6], re = f[7], de = f[8], me = f[9], ne = f[10], _e = f[11], Ee = f[12], De = f[13], xe = f[14], Ie = f[15];
    a = b[0], L += a * we, v += a * ye, R += a * pe, $ += a * le, q += a * ue, m += a * he, _ += a * ce, B += a * re, z += a * de, j2 += a * me, U += a * ne, M += a * _e, H += a * Ee, te += a * De, G += a * xe, ie += a * Ie, a = b[1], v += a * we, R += a * ye, $ += a * pe, q += a * le, m += a * ue, _ += a * he, B += a * ce, z += a * re, j2 += a * de, U += a * me, M += a * ne, H += a * _e, te += a * Ee, G += a * De, ie += a * xe, Q += a * Ie, a = b[2], R += a * we, $ += a * ye, q += a * pe, m += a * le, _ += a * ue, B += a * he, z += a * ce, j2 += a * re, U += a * de, M += a * me, H += a * ne, te += a * _e, G += a * Ee, ie += a * De, Q += a * xe, se += a * Ie, a = b[3], $ += a * we, q += a * ye, m += a * pe, _ += a * le, B += a * ue, z += a * he, j2 += a * ce, U += a * re, M += a * de, H += a * me, te += a * ne, G += a * _e, ie += a * Ee, Q += a * De, se += a * xe, T2 += a * Ie, a = b[4], q += a * we, m += a * ye, _ += a * pe, B += a * le, z += a * ue, j2 += a * he, U += a * ce, M += a * re, H += a * de, te += a * me, G += a * ne, ie += a * _e, Q += a * Ee, se += a * De, T2 += a * xe, A += a * Ie, a = b[5], m += a * we, _ += a * ye, B += a * pe, z += a * le, j2 += a * ue, U += a * he, M += a * ce, H += a * re, te += a * de, G += a * me, ie += a * ne, Q += a * _e, se += a * Ee, T2 += a * De, A += a * xe, N += a * Ie, a = b[6], _ += a * we, B += a * ye, z += a * pe, j2 += a * le, U += a * ue, M += a * he, H += a * ce, te += a * re, G += a * de, ie += a * me, Q += a * ne, se += a * _e, T2 += a * Ee, A += a * De, N += a * xe, h2 += a * Ie, a = b[7], B += a * we, z += a * ye, j2 += a * pe, U += a * le, M += a * ue, H += a * he, te += a * ce, G += a * re, ie += a * de, Q += a * me, se += a * ne, T2 += a * _e, A += a * Ee, N += a * De, h2 += a * xe, S += a * Ie, a = b[8], z += a * we, j2 += a * ye, U += a * pe, M += a * le, H += a * ue, te += a * he, G += a * ce, ie += a * re, Q += a * de, se += a * me, T2 += a * ne, A += a * _e, N += a * Ee, h2 += a * De, S += a * xe, W += a * Ie, a = b[9], j2 += a * we, U += a * ye, M += a * pe, H += a * le, te += a * ue, G += a * he, ie += a * ce, Q += a * re, se += a * de, T2 += a * me, A += a * ne, N += a * _e, h2 += a * Ee, S += a * De, W += a * xe, X += a * Ie, a = b[10], U += a * we, M += a * ye, H += a * pe, te += a * le, G += a * ue, ie += a * he, Q += a * ce, se += a * re, T2 += a * de, A += a * me, N += a * ne, h2 += a * _e, S += a * Ee, W += a * De, X += a * xe, fe += a * Ie, a = b[11], M += a * we, H += a * ye, te += a * pe, G += a * le, ie += a * ue, Q += a * he, se += a * ce, T2 += a * re, A += a * de, N += a * me, h2 += a * ne, S += a * _e, W += a * Ee, X += a * De, fe += a * xe, ve += a * Ie, a = b[12], H += a * we, te += a * ye, G += a * pe, ie += a * le, Q += a * ue, se += a * he, T2 += a * ce, A += a * re, N += a * de, h2 += a * me, S += a * ne, W += a * _e, X += a * Ee, fe += a * De, ve += a * xe, ge += a * Ie, a = b[13], te += a * we, G += a * ye, ie += a * pe, Q += a * le, se += a * ue, T2 += a * he, A += a * ce, N += a * re, h2 += a * de, S += a * me, W += a * ne, X += a * _e, fe += a * Ee, ve += a * De, ge += a * xe, Se += a * Ie, a = b[14], G += a * we, ie += a * ye, Q += a * pe, se += a * le, T2 += a * ue, A += a * he, N += a * ce, h2 += a * re, S += a * de, W += a * me, X += a * ne, fe += a * _e, ve += a * Ee, ge += a * De, Se += a * xe, Me += a * Ie, a = b[15], ie += a * we, Q += a * ye, se += a * pe, T2 += a * le, A += a * ue, N += a * he, h2 += a * ce, S += a * re, W += a * de, X += a * me, fe += a * ne, ve += a * _e, ge += a * Ee, Se += a * De, Me += a * xe, $e += a * Ie, L += 38 * Q, v += 38 * se, R += 38 * T2, $ += 38 * A, q += 38 * N, m += 38 * h2, _ += 38 * S, B += 38 * W, z += 38 * X, j2 += 38 * fe, U += 38 * ve, M += 38 * ge, H += 38 * Se, te += 38 * Me, G += 38 * $e, l = 1, a = L + l + 65535, l = Math.floor(a / 65536), L = a - l * 65536, a = v + l + 65535, l = Math.floor(a / 65536), v = a - l * 65536, a = R + l + 65535, l = Math.floor(a / 65536), R = a - l * 65536, a = $ + l + 65535, l = Math.floor(a / 65536), $ = a - l * 65536, a = q + l + 65535, l = Math.floor(a / 65536), q = a - l * 65536, a = m + l + 65535, l = Math.floor(a / 65536), m = a - l * 65536, a = _ + l + 65535, l = Math.floor(a / 65536), _ = a - l * 65536, a = B + l + 65535, l = Math.floor(a / 65536), B = a - l * 65536, a = z + l + 65535, l = Math.floor(a / 65536), z = a - l * 65536, a = j2 + l + 65535, l = Math.floor(a / 65536), j2 = a - l * 65536, a = U + l + 65535, l = Math.floor(a / 65536), U = a - l * 65536, a = M + l + 65535, l = Math.floor(a / 65536), M = a - l * 65536, a = H + l + 65535, l = Math.floor(a / 65536), H = a - l * 65536, a = te + l + 65535, l = Math.floor(a / 65536), te = a - l * 65536, a = G + l + 65535, l = Math.floor(a / 65536), G = a - l * 65536, a = ie + l + 65535, l = Math.floor(a / 65536), ie = a - l * 65536, L += l - 1 + 37 * (l - 1), l = 1, a = L + l + 65535, l = Math.floor(a / 65536), L = a - l * 65536, a = v + l + 65535, l = Math.floor(a / 65536), v = a - l * 65536, a = R + l + 65535, l = Math.floor(a / 65536), R = a - l * 65536, a = $ + l + 65535, l = Math.floor(a / 65536), $ = a - l * 65536, a = q + l + 65535, l = Math.floor(a / 65536), q = a - l * 65536, a = m + l + 65535, l = Math.floor(a / 65536), m = a - l * 65536, a = _ + l + 65535, l = Math.floor(a / 65536), _ = a - l * 65536, a = B + l + 65535, l = Math.floor(a / 65536), B = a - l * 65536, a = z + l + 65535, l = Math.floor(a / 65536), z = a - l * 65536, a = j2 + l + 65535, l = Math.floor(a / 65536), j2 = a - l * 65536, a = U + l + 65535, l = Math.floor(a / 65536), U = a - l * 65536, a = M + l + 65535, l = Math.floor(a / 65536), M = a - l * 65536, a = H + l + 65535, l = Math.floor(a / 65536), H = a - l * 65536, a = te + l + 65535, l = Math.floor(a / 65536), te = a - l * 65536, a = G + l + 65535, l = Math.floor(a / 65536), G = a - l * 65536, a = ie + l + 65535, l = Math.floor(a / 65536), ie = a - l * 65536, L += l - 1 + 37 * (l - 1), y[0] = L, y[1] = v, y[2] = R, y[3] = $, y[4] = q, y[5] = m, y[6] = _, y[7] = B, y[8] = z, y[9] = j2, y[10] = U, y[11] = M, y[12] = H, y[13] = te, y[14] = G, y[15] = ie;
  }
  function x(y, b) {
    D(y, b, b);
  }
  ...
  function C(y, b) {
    ...
    l[0] = R[0] = 1;
    for (let z = 254; z >= 0; --z) {
      const j2 = f[z >>> 3] >>> (z & 7) & 1;
      c(l, L, j2), c(v, R, j2), p($, l, v), w(l, l, v), p(v, L, R), w(L, L, R), x(R, $), x(q, l), D(l, v, l), D(v, L, $), p($, l, v), w(l, l, v), x(L, l), w(v, R, q), D(l, v, n), p(l, l, R), D(v, v, l), D(l, R, q), D(R, L, a), x(L, $), c(l, L, j2), c(v, R, j2);
    }
    for (let z = 0; z < 16; z++)
...
function xo(i) {
  ...
  r ? r.length < Io && (r = So(So([], r, true), Uf(Io - r.length), true)) : r = [];
...
function Gf() {
  ...
  function s(...w) {
    ...
    for (let x = 0; x < D.length; x++) {
      const E = D[x], C = ["itemprop", "property", "name"].map((F) => E.getAttribute(F)).filter((F) => F ? w.includes(F) : false);
      if (C.length && C) {
...
var Ac = "%[a-f0-9]{2}";
var No = new RegExp("(" + Ac + ")|([^%]+?)", "gi");
var Po = new RegExp("(" + Ac + ")+", "gi");
function Vr(i, e) {
  try {
...
(function(i) {
  ...
  function K(I, O) {
    ...
    return O.sort === false ? b : (O.sort === true ? Object.keys(b).sort() : Object.keys(b).sort(O.sort)).reduce((f, a) => {
      const l = b[a];
  ...
  i.extract = C, i.parse = K, i.stringify = (I, O) => {
    ...
    return O.sort !== false && a.sort(O.sort), a.map((l) => {
      const L = I[l];
    ...
    const y = x(I.url).split("?")[0] || "", b = i.extract(I.url), f = i.parse(b, { sort: false }), a = Object.assign(f, I.query);
...
function ip(i, e) {
  const t = ms.sharedKey(Ce(i, vt), Ce(e, vt), true), s = new Cc(Si.SHA256, t).expand(gn);
  return Ne(s, vt);
}
function sp(i) {
...
function cp(i, e) {
  const t = Ws(i);
  return Lc({ type: bs(t.type), senderPublicKey: typeof t.senderPublicKey < "u" ? Ne(t.senderPublicKey, vt) : void 0, receiverPublicKey: e == null ? void 0 : e.receiverPublicKey });
}
function Lc(i) {
  const e = (i == null ? void 0 : i.type) || Uc;
  if (e === Di) {
...
var To = (i, e, t) => e in i ? hp(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var $o = (i, e) => {
  for (var t in e || (e = {}))
...
var Uo = (i, e, t) => e in i ? Ip(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var Op = (i, e) => {
  for (var t in e || (e = {}))
...
function qp(i, e) {
  ...
  return _i(r, s) ? (s.forEach((o) => {
    ...
    (!_i($c(o, w), p) || !_i(w.methods, u) || !_i(w.events, d)) && (n = false);
  }), n) : false;
}
function Ys(i) {
...
function Yp(i, e) {
  let t = null;
  return Lo(i == null ? void 0 : i.methods) ? Lo(i == null ? void 0 : i.events) || (t = nt("UNSUPPORTED_EVENTS", `${e}, events should be an array of strings or empty array for no events`)) : t = nt("UNSUPPORTED_METHODS", `${e}, methods should be an array of strings or empty array for no methods`), t;
}
function Kc(i, e) {
  let t = null;
  return Object.values(i).forEach((s) => {
...
function eg(i) {
  return !(wt(i) || !ot(i.method, false));
}
function tg(i) {
  return !(wt(i) || wt(i.result) && wt(i.error) || !mn(i.id, false) || !ot(i.jsonrpc, false));
}
function ig(i) {
  return !(wt(i) || !ot(i.name, false));
}
function Mo(i, e) {
...
async function hg() {
  var _a2;
  return hr() && typeof global < "u" && global != null && global.NetInfo ? (_a2 = await (global == null ? void 0 : global.NetInfo.fetch())) == null ? void 0 : _a2.isConnected : true;
}
function ug() {
  return true;
}
...
function fg(i) {
  hr() && typeof global < "u" && global != null && global.NetInfo && (global == null ? void 0 : global.NetInfo.addEventListener((e) => i(e == null ? void 0 : e.isConnected)));
}
var Dr = {};
var $s = class {
  static get(e) {
...
var Bc = "INTERNAL_ERROR";
var wn = "SERVER_ERROR";
var wg = [-32700, -32600, -32601, -32602, -32603];
var hs = {
...
function Eg() {
  if (Vo)
    return Qt;
  Vo = 1, Object.defineProperty(Qt, "__esModule", { value: true }), Qt.isBrowserCryptoAvailable = Qt.getSubtleCrypto = Qt.getBrowerCrypto = void 0;
  function i() {
    return (T === null || T === void 0 ? void 0 : T.crypto) || (T === null || T === void 0 ? void 0 : T.msCrypto) || {};
  }
...
function Sg() {
  if (Bo)
    return Xt;
  Bo = 1, Object.defineProperty(Xt, "__esModule", { value: true }), Xt.isBrowser = Xt.isNode = Xt.isReactNative = void 0;
  function i() {
...
var Dg = class extends Gc {
  constructor(e) {
    super();
  }
};
var xg = class extends Gc {
  constructor() {
    super();
  }
};
...
var Yc = class {
  constructor(e) {
    if (this.url = e, this.events = new We.EventEmitter(), this.registering = false, !ko(e))
  ...
  emitError(e) {
    const t = this.parseError(new Error((e == null ? void 0 : e.message) || `WebSocket connection failed for host: ${Ho(this.url)}`));
...
(function(i, e) {
  ...
  function ve(g, P) {
    for (var k2 = -1, Z = g == null ? 0 : g.length, Re = 0, ae = []; ++k2 < Z; ) {
      var Le = g[k2];
      P(Le, k2, g) && (ae[Re++] = Le);
    }
    return ae;
  ...
  function ge(g, P) {
    for (var k2 = -1, Z = P.length, Re = g.length; ++k2 < Z; )
      g[Re + k2] = P[k2];
    return g;
  }
  function Se(g, P) {
    for (var k2 = -1, Z = g == null ? 0 : g.length; ++k2 < Z; )
      if (P(g[k2], k2, g))
        return true;
    return false;
  }
  function Me(g, P) {
    for (var k2 = -1, Z = Array(g); ++k2 < g; )
      Z[k2] = P(k2);
    return Z;
  }
  function $e(g) {
  ...
  function Wh(g, P) {
    var k2 = this.__data__;
    return this.size += this.has(g) ? 0 : 1, k2[g] = Ue && P === void 0 ? s : P, this;
  }
  ...
  function Jh(g) {
    var P = this.__data__, k2 = Ps(P, g);
    if (k2 < 0)
      return false;
    var Z = P.length - 1;
    return k2 == Z ? P.pop() : si.call(P, k2, 1), --this.size, true;
  }
  function Qh(g) {
    var P = this.__data__, k2 = Ps(P, g);
    return k2 < 0 ? void 0 : P[k2][1];
  }
  function Xh(g) {
    return Ps(this.__data__, g) > -1;
  }
  function Zh(g, P) {
    var k2 = this.__data__, Z = Ps(k2, g);
    return Z < 0 ? (++this.size, k2.push([g, P])) : k2[Z][1] = P, this;
  }
  ...
  function cu(g) {
    var P = this.__data__, k2 = P.delete(g);
    return this.size = P.size, k2;
  }
  function hu(g) {
  ...
  function lu(g, P) {
    ...
    if (k2 instanceof Yt) {
      var Z = k2.__data__;
      if (!Fe || Z.length < t - 1)
        return Z.push([g, P]), this.size = ++k2.size, this;
      k2 = this.__data__ = new pi(Z);
    }
    return k2.set(g, P), this.size = k2.size, this;
  }
  ri.prototype.clear = au, ri.prototype.delete = cu, ri.prototype.get = hu, ri.prototype.has = uu, ri.prototype.set = lu;
  function du(g, P) {
    var k2 = Cs(g), Z = !k2 && Ou(g), Re = !k2 && !Z && pr(g), ae = !k2 && !Z && !Re && Kn(g), Le = k2 || Z || Re || ae, rt = Le ? Me(g.length, String) : [], ct = rt.length;
    for (var Te in g)
  ...
  function Fn(g, P, k2, Z, Re) {
    return g === P ? true : g == null || P == null || !Bi(g) && !Bi(P) ? g !== g && P !== P : pu(g, P, k2, Z, Fn, Re);
  }
  function pu(g, P, k2, Z, Re, ae) {
    ...
    if (ft && !xt)
      return ae || (ae = new ri()), Le || Kn(g) ? Un(g, P, k2, Z, Re, ae) : wu(g, P, ct, k2, Z, Re, ae);
    if (!(k2 & r)) {
      var Rt = xt && ne.call(g, "__wrapped__"), Ct = Lt && ne.call(P, "__wrapped__");
      if (Rt || Ct) {
        var oi = Rt ? g.value() : g, Jt = Ct ? P.value() : P;
        return ae || (ae = new ri()), Re(oi, Jt, k2, Z, ae);
      }
    }
    return ft ? (ae || (ae = new ri()), bu(g, P, k2, Z, Re, ae)) : false;
  }
  function gu(g) {
    if (!zn(g) || Iu(g))
      return false;
  ...
  function mu(g) {
    if (!Du(g))
      return Os(g);
    var P = [];
    for (var k2 in Object(g))
      ne.call(g, k2) && k2 != "constructor" && P.push(k2);
    return P;
  }
  function Un(g, P, k2, Z, Re, ae) {
    var Le = k2 & r, rt = g.length, ct = P.length;
    if (rt != ct && !(Le && ct > rt))
      return false;
    var Te = ae.get(g);
    if (Te && ae.get(P))
      return Te == P;
    var xt = -1, Lt = true, ft = k2 & n ? new Ns() : void 0;
    for (ae.set(g, P), ae.set(P, g); ++xt < rt; ) {
      ...
      if (ft) {
        if (!Se(P, function(Jt, yi) {
          if (!we(ft, yi) && (Rt === Jt || Re(Rt, Jt, k2, Z, ae)))
            return ft.push(yi);
        })) {
          Lt = false;
          break;
        }
      } else if (!(Rt === Ct || Re(Rt, Ct, k2, Z, ae))) {
        Lt = false;
        break;
      }
    }
  ...
  function bu(g, P, k2, Z, Re, ae) {
    var Le = k2 & r, rt = Ln(g), ct = rt.length, Te = Ln(P), xt = Te.length;
    if (ct != xt && !Le)
      return false;
    for (var Lt = ct; Lt--; ) {
      var ft = rt[Lt];
    ...
    for (var oi = Le; ++Lt < ct; ) {
      ...
      if (!(Vn === void 0 ? Jt === yi || Re(Jt, yi, k2, Z, ae) : Vn)) {
        Ct = false;
        break;
      }
  ...
  function Rs(g, P) {
    var k2 = g.__data__;
    return Su(P) ? k2[typeof P == "string" ? "string" : "hash"] : k2.map;
  }
  function Pi(g, P) {
    var k2 = ye(g, P);
    return gu(k2) ? k2 : void 0;
  }
  function vu(g) {
    var P = ne.call(g, Dt), k2 = g[Dt];
    try {
      g[Dt] = void 0;
      var Z = true;
    } catch {
    ...
    var Re = Ee.call(g);
    return Z && (P ? g[Dt] = k2 : delete g[Dt]), Re;
  }
  ...
  (qe && ni(new qe(new ArrayBuffer(1))) != $ || Fe && ni(new Fe()) != C || je && ni(je.resolve()) != O || ze && ni(new ze()) != f || Ke && ni(new Ke()) != v) && (ni = function(g) {
    var P = Vi(g), k2 = P == I ? g.constructor : void 0, Z = k2 ? gi(k2) : "";
    if (Z)
      switch (Z) {
        case Qe:
          return $;
  ...
  function Du(g) {
    var P = g && g.constructor, k2 = typeof P == "function" && P.prototype || re;
    return g === k2;
  }
  function xu(g) {
    return Ee.call(g);
...
var Xc = (i, e) => new Vg({ ...i.decoders || { [i.prefix]: i }, ...e.decoders || { [e.prefix]: e } });
var Bg = class {
  constructor(e, t, s, r) {
...
var ur = ({ name: i, prefix: e, encode: t, decode: s }) => new Bg(i, e, t, s);
...
var lt = ({ name: i, prefix: e, bitsPerChar: t, alphabet: s }) => ur({ prefix: e, name: i, encode(r) {
  return Hg(r, s, t);
}, decode(r) {
  return kg(r, s, t, i);
} });
var Gg = ur({ prefix: "\0", name: "identity", encode: (i) => jg(i), decode: (i) => qg(i) });
...
var wy = Ss({ name: "base58flickr", prefix: "Z", alphabet: "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ" });
...
var Zc = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂");
var Dy = Zc.reduce((i, e, t) => (i[t] = e, i), []);
var xy = Zc.reduce((i, e, t) => (i[e.codePointAt(0)] = t, i), []);
function Oy(i) {
...
var Py = ur({ prefix: "🚀", name: "base256emoji", encode: Oy, decode: Ny });
...
var th = Gy;
var Jo = (i, e, t = 0) => (th.encode(i, e, t), e);
var Qo = (i) => th.encodingLength(i);
var Yr = (i, e) => {
...
var ih = ({ name: i, code: e, encode: t }) => new Yy(i, e, t);
var Yy = class {
  constructor(e, t, s) {
...
var sh = (i) => async (e) => new Uint8Array(await crypto.subtle.digest(i, e));
var Jy = ih({ name: "sha2-256", code: 18, encode: sh("SHA-256") });
var Qy = ih({ name: "sha2-512", code: 19, encode: sh("SHA-512") });
var Xy = Object.freeze({ __proto__: null, sha256: Jy, sha512: Qy });
var rh = 0;
var Zy = "identity";
var nh = Qc;
var e1 = (i) => Yr(rh, nh(i));
var t1 = { code: rh, name: Zy, encode: nh, digest: e1 };
var i1 = Object.freeze({ __proto__: null, identity: t1 });
new TextEncoder(), new TextDecoder();
var Xo = { ...Wg, ...Jg, ...Xg, ...ey, ...sy, ...fy, ...yy, ...by, ...Iy, ...Ry };
({ ...Xy, ...i1 });
function oh(i) {
  return globalThis.Buffer != null ? new Uint8Array(i.buffer, i.byteOffset, i.byteLength) : i;
}
...
var Zo = ah("utf8", "u", (i) => "u" + new TextDecoder("utf8").decode(i), (i) => new TextEncoder().encode(i.substring(1)));
var xr = ah("ascii", "a", (i) => {
  let e = "a";
  for (let t = 0; t < i.length; t++)
    e += String.fromCharCode(i[t]);
...
var r1 = { utf8: Zo, "utf-8": Zo, hex: Xo.base16, latin1: xr, ascii: xr, binary: xr, ...Xo };
...
var hh = "irn";
var m1 = "error";
var uh = "wss://relay.walletconnect.com";
var ta = "wss://relay.walletconnect.org";
var w1 = "relayer";
...
var T1 = "0.3";
var Or = "verify-api";
var zs = "https://verify.walletconnect.com";
var ia = "https://verify.walletconnect.org";
var $1 = class {
  constructor(e, t) {
...
var L1 = class extends yl {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new We.EventEmitter(), this.name = y1, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = V.toMiliseconds(V.TEN_SECONDS), this.needsTransportRestart = false, this.publish = async (s, r, n) => {
      ...
      try {
        const c = (n == null ? void 0 : n.ttl) || g1, u = Gr(n), d = (n == null ? void 0 : n.prompt) || false, p = (n == null ? void 0 : n.tag) || 0, w = (n == null ? void 0 : n.id) || vn().toString(), D = { topic: s, message: r, opts: { ttl: c, relay: u, prompt: d, tag: p, id: w } }, x = setTimeout(() => this.queue.set(w, D), this.publishTimeout);
        try {
...
var ra = (i, e, t) => e in i ? q1(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var Zi = (i, e) => {
  for (var t in e || (e = {}))
...
var Nr = (i, e) => j1(i, z1(e));
var B1 = class extends bl {
  constructor(e, t) {
...
var oa = (i, e, t) => e in i ? k1(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var W1 = (i, e) => {
  for (var t in e || (e = {}))
...
var Y1 = class extends ml {
  constructor(e) {
    super(e), this.protocol = "wc", this.version = 2, this.events = new We.EventEmitter(), this.name = w1, this.transportExplicitlyClosed = false, this.initialized = false, this.connectionAttemptInProgress = false, this.connectionStatusPollingInterval = 20, this.staleConnectionErrors = ["socket hang up", "socket stalled"], this.hasExperiencedNetworkDisruption = false, this.request = async (t) => {
    ...
    }, this.core = e.core, this.logger = typeof e.logger < "u" && typeof e.logger != "string" ? ee.generateChildLogger(e.logger, this.name) : ee.pino(ee.getDefaultLoggerOptions({ level: e.logger || m1 })), this.messages = new U1(this.logger, e.core), this.subscriber = new B1(this, this.logger), this.publisher = new L1(this, this.logger), this.relayUrl = (e == null ? void 0 : e.relayUrl) || uh, this.projectId = e.projectId, this.provider = {};
  }
  async init() {
  ...
  async createProvider() {
    ...
    this.provider = new _n(new Yc(bp({ sdkVersion: _1, protocol: this.protocol, version: this.version, relayUrl: this.relayUrl, projectId: this.projectId, auth: e, useOnCloseEvent: true }))), this.registerProviderListeners();
  }
...
var ca = (i, e, t) => e in i ? J1(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var ha = (i, e) => {
  for (var t in e || (e = {}))
...
var Z1 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.name = N1, this.version = P1, this.events = new tr(), this.initialized = false, this.storagePrefix = hi, this.ignoredPayloadTypes = [Di], this.registeredMethods = [], this.init = async () => {
      ...
      this.isInitialized();
      const s = Hr(), r = await this.core.crypto.setSymKey(s), n = Mt(V.FIVE_MINUTES), o = { protocol: hh }, c = { topic: r, expiry: n, relay: o, active: false }, u = Ap({ protocol: this.core.protocol, version: this.core.version, topic: r, symKey: s, relay: o });
...
var im = class extends _l {
  constructor(e, t) {
    super(e, t), this.projectId = e, this.logger = t, this.name = Or, this.initialized = false, this.queue = [], this.verifyDisabled = false, this.init = async (s) => {
      if (this.verifyDisabled || hr() || !vs())
        return;
      const r = (s == null ? void 0 : s.verifyUrl) || zs;
...
var la = (i, e, t) => e in i ? sm(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var da = (i, e) => {
  for (var t in e || (e = {}))
...
var om = class lh extends fl {
  constructor(e) {
    super(e), this.protocol = ch, this.version = o1, this.name = En, this.events = new We.EventEmitter(), this.initialized = false, this.on = (s, r) => this.events.on(s, r), this.once = (s, r) => this.events.once(s, r), this.off = (s, r) => this.events.off(s, r), this.removeListener = (s, r) => this.events.removeListener(s, r), this.projectId = e == null ? void 0 : e.projectId, this.relayUrl = (e == null ? void 0 : e.relayUrl) || uh;
    ...
    this.logger = ee.generateChildLogger(t, this.name), this.heartbeat = new Wt.HeartBeat(), this.crypto = new F1(this, this.logger, e == null ? void 0 : e.keychain), this.history = new em(this, this.logger), this.expirer = new tm(this, this.logger), this.storage = e != null && e.storage ? e.storage : new oc(da(da({}, c1), e == null ? void 0 : e.storageOptions)), this.relayer = new Y1({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new Z1(this, this.logger), this.verify = new im(this.projectId || "", this.logger);
  }
  static async init(e) {
    const t = new lh(e);
    await t.initialize();
...
var ph = "client";
var Sn = `${dh}@${fh}:${ph}:`;
var Pr = { name: ph, logger: "error", controller: false, relayUrl: "wss://relay.walletconnect.com" };
var fa = "WALLETCONNECT_DEEPLINK_CHOICE";
var cm = "proposal";
...
var Rr = { min: V.FIVE_MINUTES, max: V.SEVEN_DAYS };
...
var ga = (i, e, t) => e in i ? pm(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var Et = (i, e) => {
  for (var t in e || (e = {}))
...
var bm = class extends Sl {
  constructor(e) {
    super(e), this.name = lm, this.events = new tr(), this.initialized = false, this.ignoredPayloadTypes = [Di], this.requestQueue = { state: ei.idle, queue: [] }, this.sessionRequestQueue = { state: ei.idle, queue: [] }, this.requestQueueDelay = V.ONE_SECOND, this.init = async () => {
      ...
      await this.client.core.relayer.subscribe(E), await this.sendRequest({ topic: E, method: "wc_sessionSettle", params: C, throwOnFailedPublish: true });
      const F = ts(Et({}, C), { topic: E, pairingTopic: u, acknowledged: false, self: C.controller, peer: { publicKey: d.publicKey, metadata: d.metadata }, controller: D });
      ...
      return this.events.once(Be("session_request", c), ({ error: w, result: D }) => {
        ...
        await this.sendRequest({ clientRpcId: c, topic: n, method: "wc_sessionRequest", params: { request: r, chainId: s }, expiry: o, throwOnFailedPublish: true }).catch((D) => p(D)), this.client.events.emit("session_request_sent", { topic: n, request: r, chainId: s, id: c }), w();
      }), new Promise(async (w) => {
      ...
      return o && (D.ttl = o), c && (D.id = c), this.client.core.history.set(s, p), d ? (D.internal = ts(Et({}, D.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(s, w, D)) : this.client.core.relayer.publish(s, w, D).catch((x) => this.client.logger.error(x)), p.id;
      ...
      o ? (p.internal = ts(Et({}, p.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(r, u, p)) : this.client.core.relayer.publish(r, u, p).catch((w) => this.client.logger.error(w)), await this.client.core.history.resolve(c);
      ...
      try {
        ...
        const { relay: o, controller: c, expiry: u, namespaces: d, requiredNamespaces: p, optionalNamespaces: w, sessionProperties: D, pairingTopic: x } = s.params, E = Et({ topic: t, relay: o, expiry: u, namespaces: d, acknowledged: true, pairingTopic: x, requiredNamespaces: p, optionalNamespaces: w, controller: c.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: c.publicKey, metadata: c.metadata } }, D && { sessionProperties: D });
        await this.sendResult({ id: s.id, topic: t, result: true }), this.events.emit(Be("session_connect"), { session: E }), this.cleanupDuplicatePairings(E);
      } catch (o) {
      ...
      if (wt(s) || await this.isValidPairingTopic(s), !Qp(c, true)) {
...
var Sm = class gh extends El {
  constructor(e) {
    ...
    }, this.name = (e == null ? void 0 : e.name) || Pr.name, this.metadata = (e == null ? void 0 : e.metadata) || gp();
    const t = typeof (e == null ? void 0 : e.logger) < "u" && typeof (e == null ? void 0 : e.logger) != "string" ? e.logger : ee.pino(ee.getDefaultLoggerOptions({ level: (e == null ? void 0 : e.logger) || Pr.logger }));
    this.core = (e == null ? void 0 : e.core) || new am(e), this.logger = ee.generateChildLogger(t, this.name), this.session = new _m(this.core, this.logger), this.proposal = new vm(this.core, this.logger), this.pendingRequest = new Em(this.core, this.logger), this.engine = new bm(this);
  }
  static async init(e) {
    const t = new gh(e);
...
var kt = new Nm();
var Qs = constants_exports.NetworkName;
var Pm = async ({
  projectId: i,
  chainId: e,
  name: t,
  ...
  try {
    ...
    h(), await new Promise((I) => setTimeout(I, 200));
...
function bh(i) {
  const e = (i == null ? void 0 : i.type) || wh;
  if (e === Ni) {
    if (typeof (i == null ? void 0 : i.senderPublicKey) > "u")
      throw new Error("missing sender public key");
    if (typeof (i == null ? void 0 : i.receiverPublicKey) > "u")
...
var cw = Object.prototype.propertyIsEnumerable;
var ba = (i, e, t) => e in i ? ow(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var va = (i, e) => {
  for (var t in e || (e = {}))
...
var vw = "irn";
function Zr(i) {
  return (i == null ? void 0 : i.relay) || { protocol: vw };
}
function Ks(i) {
  const e = Tc[i];
  if (typeof e > "u")
...
var Ea = (i, e, t) => e in i ? _w(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var Iw = (i, e) => {
  for (var t in e || (e = {}))
...
var $w = { INVALID_METHOD: { message: "Invalid method.", code: 1001 }, INVALID_EVENT: { message: "Invalid event.", code: 1002 }, INVALID_UPDATE_REQUEST: { message: "Invalid update request.", code: 1003 }, INVALID_EXTEND_REQUEST: { message: "Invalid extend request.", code: 1004 }, INVALID_SESSION_SETTLE_REQUEST: { message: "Invalid session settle request.", code: 1005 }, UNAUTHORIZED_METHOD: { message: "Unauthorized method.", code: 3001 }, UNAUTHORIZED_EVENT: { message: "Unauthorized event.", code: 3002 }, UNAUTHORIZED_UPDATE_REQUEST: { message: "Unauthorized update request.", code: 3003 }, UNAUTHORIZED_EXTEND_REQUEST: { message: "Unauthorized extend request.", code: 3004 }, USER_REJECTED: { message: "User rejected.", code: 5e3 }, USER_REJECTED_CHAINS: { message: "User rejected chains.", code: 5001 }, USER_REJECTED_METHODS: { message: "User rejected methods.", code: 5002 }, USER_REJECTED_EVENTS: { message: "User rejected events.", code: 5003 }, UNSUPPORTED_CHAINS: { message: "Unsupported chains.", code: 5100 }, UNSUPPORTED_METHODS: { message: "Unsupported methods.", code: 5101 }, UNSUPPORTED_EVENTS: { message: "Unsupported events.", code: 5102 }, UNSUPPORTED_ACCOUNTS: { message: "Unsupported accounts.", code: 5103 }, UNSUPPORTED_NAMESPACE_KEY: { message: "Unsupported namespace key.", code: 5104 }, USER_DISCONNECTED: { message: "User disconnected.", code: 6e3 }, SESSION_SETTLEMENT_FAILED: { message: "Session settlement failed.", code: 7e3 }, WC_METHOD_UNSUPPORTED: { message: "Unsupported wc_ method.", code: 10001 } };
var Fw = { NOT_INITIALIZED: { message: "Not initialized.", code: 1 }, NO_MATCHING_KEY: { message: "No matching key.", code: 2 }, RESTORE_WILL_OVERRIDE: { message: "Restore will override.", code: 3 }, RESUBSCRIBED: { message: "Resubscribed.", code: 4 }, MISSING_OR_INVALID: { message: "Missing or invalid.", code: 5 }, EXPIRED: { message: "Expired.", code: 6 }, UNKNOWN_TYPE: { message: "Unknown type.", code: 7 }, MISMATCHED_TOPIC: { message: "Mismatched topic.", code: 8 }, NON_CONFORMING_NAMESPACES: { message: "Non conforming namespaces.", code: 9 } };
function J(i, e) {
...
function Uw(i, e) {
  ...
  return Ei(r, s) ? (s.forEach((o) => {
    ...
    (!Ei(In(o, w), p) || !Ei(w.methods, u) || !Ei(w.events, d)) && (n = false);
  }), n) : false;
}
function Rn(i) {
...
function kw(i, e) {
  ...
  return Object.values(i).forEach((s) => {
    if (t)
      return;
    const r = Bw(s == null ? void 0 : s.accounts, `${e} namespace`);
    r && (t = r);
  }), t;
}
function Hw(i, e) {
  let t = null;
  return Sa(i == null ? void 0 : i.methods) ? Sa(i == null ? void 0 : i.events) || (t = Je("UNSUPPORTED_EVENTS", `${e}, events should be an array of strings or empty array for no events`)) : t = Je("UNSUPPORTED_METHODS", `${e}, methods should be an array of strings or empty array for no methods`), t;
}
function Dh(i, e) {
  let t = null;
  return Object.values(i).forEach((s) => {
...
function Qw(i) {
  return !(bt(i) || !at(i.method, false));
}
function Xw(i) {
  return !(bt(i) || bt(i.result) && bt(i.error) || !Pn(i.id, false) || !at(i.jsonrpc, false));
}
function Zw(i) {
  return !(bt(i) || !at(i.name, false));
}
function Ia(i, e) {
  return !(!Rn(e) || !Rw(i).includes(e));
}
function eb(i, e, t) {
  return at(t, false) ? Cw(i, e).includes(t) : false;
}
function tb(i, e, t) {
  return at(t, false) ? Aw(i, e).includes(t) : false;
}
function Da(i, e, t) {
  let s = null;
...
var cb = (i) => new TextEncoder().encode(i);
var hb = (i) => new TextDecoder().decode(i);
var ub = class {
  constructor(e, t, s) {
    this.name = e, this.prefix = t, this.baseEncode = s;
  }
...
var Nh = (i, e) => new db({ ...i.decoders || { [i.prefix]: i }, ...e.decoders || { [e.prefix]: e } });
var fb = class {
  constructor(e, t, s, r) {
...
var dr = ({ name: i, prefix: e, encode: t, decode: s }) => new fb(i, e, t, s);
...
var dt = ({ name: i, prefix: e, bitsPerChar: t, alphabet: s }) => dr({ prefix: e, name: i, encode(r) {
  return gb(r, s, t);
}, decode(r) {
  return pb(r, s, t, i);
} });
var yb = dr({ prefix: "\0", name: "identity", encode: (i) => hb(i), decode: (i) => cb(i) });
var mb = Object.freeze({ __proto__: null, identity: yb });
var wb = dt({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
var bb = Object.freeze({ __proto__: null, base2: wb });
var vb = dt({ prefix: "7", name: "base8", alphabet: "01234567", bitsPerChar: 3 });
var _b = Object.freeze({ __proto__: null, base8: vb });
var Eb = xs({ prefix: "9", name: "base10", alphabet: "0123456789" });
var Sb = Object.freeze({ __proto__: null, base10: Eb });
var Ib = dt({ prefix: "f", name: "base16", alphabet: "0123456789abcdef", bitsPerChar: 4 });
var Db = dt({ prefix: "F", name: "base16upper", alphabet: "0123456789ABCDEF", bitsPerChar: 4 });
var xb = Object.freeze({ __proto__: null, base16: Ib, base16upper: Db });
var Ob = dt({ prefix: "b", name: "base32", alphabet: "abcdefghijklmnopqrstuvwxyz234567", bitsPerChar: 5 });
var Nb = dt({ prefix: "B", name: "base32upper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567", bitsPerChar: 5 });
var Pb = dt({ prefix: "c", name: "base32pad", alphabet: "abcdefghijklmnopqrstuvwxyz234567=", bitsPerChar: 5 });
var Rb = dt({ prefix: "C", name: "base32padupper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567=", bitsPerChar: 5 });
var Cb = dt({ prefix: "v", name: "base32hex", alphabet: "0123456789abcdefghijklmnopqrstuv", bitsPerChar: 5 });
var Ab = dt({ prefix: "V", name: "base32hexupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV", bitsPerChar: 5 });
var Tb = dt({ prefix: "t", name: "base32hexpad", alphabet: "0123456789abcdefghijklmnopqrstuv=", bitsPerChar: 5 });
var $b = dt({ prefix: "T", name: "base32hexpadupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV=", bitsPerChar: 5 });
var Fb = dt({ prefix: "h", name: "base32z", alphabet: "ybndrfg8ejkmcpqxot1uwisza345h769", bitsPerChar: 5 });
...
var Lb = xs({ prefix: "k", name: "base36", alphabet: "0123456789abcdefghijklmnopqrstuvwxyz" });
var Mb = xs({ prefix: "K", name: "base36upper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ" });
var qb = Object.freeze({ __proto__: null, base36: Lb, base36upper: Mb });
var jb = xs({ name: "base58btc", prefix: "z", alphabet: "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz" });
var zb = xs({ name: "base58flickr", prefix: "Z", alphabet: "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ" });
var Kb = Object.freeze({ __proto__: null, base58btc: jb, base58flickr: zb });
var Vb = dt({ prefix: "m", name: "base64", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", bitsPerChar: 6 });
var Bb = dt({ prefix: "M", name: "base64pad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", bitsPerChar: 6 });
var kb = dt({ prefix: "u", name: "base64url", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", bitsPerChar: 6 });
var Hb = dt({ prefix: "U", name: "base64urlpad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=", bitsPerChar: 6 });
var Gb = Object.freeze({ __proto__: null, base64: Vb, base64pad: Bb, base64url: kb, base64urlpad: Hb });
var Ph = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂");
var Wb = Ph.reduce((i, e, t) => (i[t] = e, i), []);
var Yb = Ph.reduce((i, e, t) => (i[e.codePointAt(0)] = t, i), []);
function Jb(i) {
...
var Xb = dr({ prefix: "🚀", name: "base256emoji", encode: Jb, decode: Qb });
var Zb = Object.freeze({ __proto__: null, base256emoji: Xb });
var e0 = Rh;
var Oa = 128;
var t0 = 127;
var i0 = ~t0;
...
var Ch = y0;
var Pa = (i, e, t = 0) => (Ch.encode(i, e, t), e);
var Ra = (i) => Ch.encodingLength(i);
var tn = (i, e) => {
...
var Ah = ({ name: i, code: e, encode: t }) => new w0(i, e, t);
var w0 = class {
  constructor(e, t, s) {
    this.name = e, this.code = t, this.encode = s;
  }
...
var Th = (i) => async (e) => new Uint8Array(await crypto.subtle.digest(i, e));
var b0 = Ah({ name: "sha2-256", code: 18, encode: Th("SHA-256") });
var v0 = Ah({ name: "sha2-512", code: 19, encode: Th("SHA-512") });
var _0 = Object.freeze({ __proto__: null, sha256: b0, sha512: v0 });
var $h = 0;
var E0 = "identity";
var Fh = Oh;
var S0 = (i) => tn($h, Fh(i));
var I0 = { code: $h, name: E0, encode: Fh, digest: S0 };
var D0 = Object.freeze({ __proto__: null, identity: I0 });
new TextEncoder(), new TextDecoder();
var Ca = { ...mb, ...bb, ..._b, ...Sb, ...xb, ...Ub, ...qb, ...Kb, ...Gb, ...Zb };
({ ..._0, ...D0 });
function Uh(i) {
  return globalThis.Buffer != null ? new Uint8Array(i.buffer, i.byteOffset, i.byteLength) : i;
}
...
var Aa = Lh("utf8", "u", (i) => "u" + new TextDecoder("utf8").decode(i), (i) => new TextEncoder().encode(i.substring(1)));
var Cr = Lh("ascii", "a", (i) => {
  let e = "a";
  for (let t = 0; t < i.length; t++)
    e += String.fromCharCode(i[t]);
...
var O0 = { utf8: Aa, "utf-8": Aa, hex: Ca.base16, latin1: Cr, ascii: Cr, binary: Cr, ...Ca };
...
var qh = "irn";
var j0 = "error";
var jh = "wss://relay.walletconnect.com";
var z0 = "relayer";
...
var tv = "0.3";
var Ar = "verify-api";
var $a = "https://verify.walletconnect.com";
var iv = class {
  constructor(e, t) {
...
var nv = class extends Fm {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new We.EventEmitter(), this.name = q0, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = 1e4, this.publish = async (s, r, n) => {
      this.logger.debug("Publishing Payload"), this.logger.trace({ type: "method", method: "publish", params: { topic: s, message: r, opts: n } });
      try {
        const o = (n == null ? void 0 : n.ttl) || M0, c = Zr(n), u = (n == null ? void 0 : n.prompt) || false, d = (n == null ? void 0 : n.tag) || 0, p = (n == null ? void 0 : n.id) || vn().toString(), w = { topic: s, message: r, opts: { ttl: o, relay: c, prompt: u, tag: d, id: p } };
        this.queue.set(p, w);
        try {
...
var Ua = (i, e, t) => e in i ? av(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var rs = (i, e) => {
  for (var t in e || (e = {}))
...
var Ma = (i, e, t) => e in i ? fv(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var yv = (i, e) => {
  for (var t in e || (e = {}))
...
var mv = class extends Um {
  ...
  async createProvider() {
    const e = await this.core.crypto.signJWT(this.relayUrl);
    this.provider = new _n(new Yc(mw({ sdkVersion: B0, protocol: this.protocol, version: this.version, relayUrl: this.relayUrl, projectId: this.projectId, auth: e, useOnCloseEvent: true }))), this.registerProviderListeners();
  }
  async recordMessageEvent(e) {
    const { topic: t, message: s } = e;
    await this.messages.set(t, s);
...
var ja = (i, e, t) => e in i ? wv(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var za = (i, e) => {
  for (var t in e || (e = {}))
...
var _v = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.name = J0, this.version = Q0, this.events = new tr(), this.initialized = false, this.storagePrefix = ui, this.ignoredPayloadTypes = [Ni], this.registeredMethods = [], this.init = async () => {
      this.initialized || (await this.pairings.init(), await this.cleanup(), this.registerRelayerEvents(), this.registerExpirerEvents(), this.initialized = true, this.logger.trace("Initialized"));
    }, this.register = ({ methods: s }) => {
      this.isInitialized(), this.registeredMethods = [.../* @__PURE__ */ new Set([...this.registeredMethods, ...s])];
    }, this.create = async () => {
      this.isInitialized();
      const s = Xr(), r = await this.core.crypto.setSymKey(s), n = Ht(V.FIVE_MINUTES), o = { protocol: qh }, c = { topic: r, expiry: n, relay: o, active: false }, u = Pw({ protocol: this.core.protocol, version: this.core.version, topic: r, symKey: s, relay: o });
      return await this.pairings.set(r, c), await this.core.relayer.subscribe(r), this.core.expirer.set(r, n), { topic: r, uri: u };
    }, this.pair = async (s) => {
      this.isInitialized(), this.isValidPair(s);
...
var Iv = class extends jm {
  constructor(e, t) {
    super(e, t), this.projectId = e, this.logger = t, this.name = Ar, this.initialized = false, this.init = async (s) => {
      vh() || !Nn() || (this.verifyUrl = (s == null ? void 0 : s.verifyUrl) || $a, await this.createIframe());
    }, this.register = async (s) => {
      var r;
...
var Va = (i, e, t) => e in i ? Dv(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var Ba = (i, e) => {
  for (var t in e || (e = {}))
...
var Nv = class zh extends Am {
  constructor(e) {
    super(e), this.protocol = Mh, this.version = P0, this.name = Cn, this.events = new We.EventEmitter(), this.initialized = false, this.on = (s, r) => this.events.on(s, r), this.once = (s, r) => this.events.once(s, r), this.off = (s, r) => this.events.off(s, r), this.removeListener = (s, r) => this.events.removeListener(s, r), this.projectId = e == null ? void 0 : e.projectId, this.relayUrl = (e == null ? void 0 : e.relayUrl) || jh;
    ...
    this.logger = ee.generateChildLogger(t, this.name), this.heartbeat = new Wt.HeartBeat(), this.crypto = new sv(this, this.logger, e == null ? void 0 : e.keychain), this.history = new Ev(this, this.logger), this.expirer = new Sv(this, this.logger), this.storage = e != null && e.storage ? e.storage : new oc(Ba(Ba({}, C0), e == null ? void 0 : e.storageOptions)), this.relayer = new mv({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new _v(this, this.logger), this.verify = new Iv(this.projectId || "", this.logger);
  }
  static async init(e) {
    const t = new zh(e);
    return await t.initialize(), t;
...
var Bh = "client";
var An = `${Kh}@${Vh}:${Bh}:`;
var $r = { name: Bh, logger: "error", controller: false, relayUrl: "wss://relay.walletconnect.com" };
var Rv = "proposal";
...
var Fr = { min: V.FIVE_MINUTES, max: V.SEVEN_DAYS };
var $v = "request";
...
var Ha = (i, e, t) => e in i ? Uv(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var At = (i, e) => {
  for (var t in e || (e = {}))
...
var Ur = (i, e) => Lv(i, Mv(e));
var zv = class extends Km {
  constructor(e) {
    super(e), this.name = Tv, this.events = new tr(), this.initialized = false, this.ignoredPayloadTypes = [Ni], this.init = async () => {
      ...
      const F = Ur(At({}, C), { topic: E, pairingTopic: u, acknowledged: false, self: C.controller, peer: { publicKey: d.publicKey, metadata: d.metadata }, controller: D });
      ...
      try {
        this.isValidSessionSettleRequest(n);
        const { relay: o, controller: c, expiry: u, namespaces: d, requiredNamespaces: p, optionalNamespaces: w, sessionProperties: D, pairingTopic: x } = s.params, E = At({ topic: t, relay: o, expiry: u, namespaces: d, acknowledged: true, pairingTopic: x, requiredNamespaces: p, optionalNamespaces: w, controller: c.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: c.publicKey, metadata: c.metadata } }, D && { sessionProperties: D });
        await this.sendResult(s.id, t, true), this.events.emit(ke("session_connect"), { session: E }), this.cleanupDuplicatePairings(E);
      } catch (o) {
        await this.sendError(r, t, o), this.client.logger.error(o);
      }
    }, this.onSessionSettleResponse = async (t, s) => {
      ...
      const { pairingTopic: s, requiredNamespaces: r, optionalNamespaces: n, sessionProperties: o, relays: c } = t;
      if (bt(s) || await this.isValidPairingTopic(s), !Ww(c, true)) {
...
var Tn = class _Tn extends zm {
  constructor(e) {
    ...
    }, this.name = (e == null ? void 0 : e.name) || $r.name, this.metadata = (e == null ? void 0 : e.metadata) || fw();
    const t = typeof (e == null ? void 0 : e.logger) < "u" && typeof (e == null ? void 0 : e.logger) != "string" ? e.logger : ee.pino(ee.getDefaultLoggerOptions({ level: (e == null ? void 0 : e.logger) || $r.logger }));
...
var r_ = class extends e_ {
  constructor({ client: t, chainId: s, rpcUrl: r }) {
    ...
    if (this.chainId = String(s || "SN_GOERLI"), this.rpc = {
      ...
      this.provider = new Provider({ rpc: { nodeUrl: r } });
    else {
      const n = this.getNetworkName(this.chainId);
      this.provider = new Provider({ sequencer: { network: n } });
    }
    this.account = new Ga(
      this.provider,
      "",
  ...
  getNetworkName(t) {
    if (t === "SN_GOERLI")
      return constants_exports.NetworkName.SN_GOERLI;
    if (t === "SN_MAIN")
...
var W_ = async (i) => Pm(i, r_);
export {
  W_ as getStarknetWindowObject
};
/*! Bundled license information:

starknetkit/dist/index-c78ebd52.js:
  (*! *****************************************************************************
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=index-c78ebd52-NA6XPNVE.js.map
